...
class Containers extends Base {
   ...
   * @param {('default'|'none'|'small'|'medium'|'large'|'extraLarge'|'padding')|(Spacing.default|Spacing.none|Spacing.small|Spacing.medium|Spacing.large|Spacing.xl|Spacing.padding)} [spacing] container spacing. one of this.Spacing
   ...
   * @param {('emphasis'|'good'|'attention'|'warning'|'accent'|'default')|(ContainerStyles.grey|ContainerStyles.green|ContainerStyles.red|ContainerStyles.yellow|ContainerStyles.blue|ContainerStyles.default)} [style = ContainerStyles.default] container style. one of ContainerStyles. is 'default' by default
   ...
   * @param {Boolean} [rtl = false] works on v1.5 and later, when true content in this Container should be presented right to left. defaults to false.
   * @param {Boolean} [separator = false] show separator(divider) on top. defaults to false.
   * @param {('default'|'none'|'small'|'medium'|'large'|'extraLarge'|'padding')|(Spacing.default|Spacing.none|Spacing.small|Spacing.medium|Spacing.large|Spacing.xl|Spacing.padding)} [spacing] column spacing. one of this.Spacing
   * @param {object} [selectAction] action object on click.
   * @param {('emphasis'|'good'|'attention'|'warning'|'accent'|'default')|(ContainerStyles.grey|ContainerStyles.green|ContainerStyles.red|ContainerStyles.yellow|ContainerStyles.blue|ContainerStyles.default)} [style = ContainerStyles.default] container style. one of ContainerStyles. is 'default' by default
   ...
   * @param {('emphasis'|'good'|'attention'|'warning'|'accent'|'default')|(ContainerStyles.grey|ContainerStyles.green|ContainerStyles.red|ContainerStyles.yellow|ContainerStyles.blue|ContainerStyles.default)} [gridStyle = 'default'] container style. one of ContainerStyles. is 'default' by default
